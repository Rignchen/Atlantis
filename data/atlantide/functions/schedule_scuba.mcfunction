...
execute if score #temp atlantide.oxygene matches 1 unless score @s[gamemode=!creative,gamemode=!spectator] atlantide.oxygene matches 0 run function atlantide:armor/under_water
